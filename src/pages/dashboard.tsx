...
import { useRoqPlatformUserProfiles, useTeamCount, useTransactionCount, useRechargeCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const rechargeStat = useRechargeCount();
