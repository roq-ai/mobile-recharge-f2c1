...
import { useRoqClient, useRechargeFindManyWithCount } from 'lib/roq';
...
export function RechargeListPage(props: RechargeListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useRechargeFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.recharge.delete({ where: { id } });
      await mutate();
    } catch (error) {
