...
export function useRechargeFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useRechargeFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.recharge.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useRechargeCount<T extends Prisma.rechargeCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.rechargeCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useRechargeCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.recharge.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useRechargeFindManyWithCount<
  T extends Prisma.rechargeFindManyArgs,
  R extends { data: GetFindResult<Prisma.$rechargePayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.rechargeFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useRechargeFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.recharge.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useRechargeFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useRechargeFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.recharge.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
